...
<div class="photograph">
	<img class="center" src="images/applications/38010459/38010459.jpg" alt="applicant photo" /><br />
 ...
 <form  method="POST" class="form-horizontal" role="form">
  <div class="form-group">
     <label for="id1_1" class="control-label col-xs-2">1. आवेदक का नाम :</label>
        <div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id1_1.jpg" alt="" id="id1_1_img" /><br />
  ...
  <div class="form-group">
     <label for="id2_1" class="control-label col-xs-2">2. लिंग :</label>
        <div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id2_1.jpg" alt="" id="id2_1_img" /><br />
			बालिका &nbsp; <input type="radio" name="id2_1" value="male" id="id2_1">&nbsp;&nbsp;&nbsp;&nbsp;
			बालक &nbsp; <input type="radio" name="id2_1" value="female" id="id2_2">
        </div>
  </div>
  <div class="form-group">
     <label for="id3_1" class="control-label col-xs-2">3. जन्म तिथि :</label>
        <div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id3_1.jpg" alt="" id="id3_1_img" /><br />			
			दिन &nbsp; 
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id5_1.jpg" alt="" id="id5_1_img" /><br />			
			<input type="text" class="form-control" id="id5_1" name="id5_1"><br />
			पुत्र श्री : &nbsp;	
			<img class="form_images" src="images/applications/38010459/id5_2.jpg" alt="" id="id5_2_img" /><br />
			<input type="text" class="form-control" id="id5_2" name="id5_2"><br />
			शैक्षिक योग्यता : &nbsp;			
			<img class="form_images" src="images/applications/38010459/id5_3.jpg" alt="" id="id5_3_img" /><br />	
			<input type="text" class="form-control" id="id5_3" name="id5_3"><br />
			व्यवसाय : &nbsp;	
			<img class="form_images" src="images/applications/38010459/id5_4.jpg" alt="" id="id5_4_img" /><br />			
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id6_1.jpg" alt="" id="id6_1_img" /><br />			
			<input type="text" class="form-control" id="id6_1" name="id6_1"><br />
			पुत्री श्री : &nbsp;	
			<img class="form_images" src="images/applications/38010459/id6_2.jpg" alt="" id="id6_2_img" /><br />			
			<input type="text" class="form-control" id="id6_2" name="id6_2"><br />
			शैक्षिक योग्यता : &nbsp;	
			<img class="form_images" src="images/applications/38010459/id6_3.jpg" alt="" id="id6_3_img" /><br />			
			<input type="text" class="form-control" id="id6_3" name="id6_3"><br />
			व्यवसाय : &nbsp;	
			<img class="form_images" src="images/applications/38010459/id6_4.jpg" alt="" id="id6_4_img" /><br />			
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			ग्राम का नाम : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_1.jpg" alt="" id="id7_1_img" /><br />
			<input type="text" class="form-control" id="id7_1" name="id7_1"><br />
			पोस्ट ऑफिस &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_2.jpg" alt="" id="id7_2_img" /><br />
			<input type="text" class="form-control" id="id7_2" name="id7_2"><br /> 
			विकास खण्ड : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_3.jpg" alt="" id="id7_3_img" /><br />
			<input type="text" class="form-control" id="id7_3" name="id7_3"><br />
			तहसील &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_4.jpg" alt="" id="id7_4_img" /><br />
			<input type="text" class="form-control" id="id7_4" name="id7_4"><br /> 
			जिला : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_5.jpg" alt="" id="id7_5_img" /><br />
			<input type="text" class="form-control" id="id7_5" name="id7_5"><br />
			पिन कोड &nbsp; 
			<img class="form_images" src="images/applications/38010459/id7_6.jpg" alt="" id="id7_6_img" /><br />
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			...
			<img class="form_images" src="images/applications/38010459/id8_1.jpg" alt="" id="id8_1_img" /><br />
			<input type="text" class="form-control" id="id8_1" name="id8_1"><br />
			(ब) विद्यार्थी का संरक्षक से संबंध : &nbsp;
			<img class="form_images" src="images/applications/38010459/id8_2.jpg" alt="" id="id8_2_img" /><br />
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			ग्राम का नाम : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_1.jpg" alt="" id="id9_1_img" /><br />
			<input type="text" class="form-control" id="id9_1" name="id9_1"><br />
			पोस्ट ऑफिस &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_2.jpg" alt="" id="id9_2_img" /><br />
			<input type="text" class="form-control" id="id9_2" name="id9_2"><br /> 
			विकास खण्ड : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_3.jpg" alt="" id="id9_3_img" /><br />
			<input type="text" class="form-control" id="id9_3" name="id9_3"><br />
			तहसील &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_4.jpg" alt="" id="id9_4_img" /><br />
			<input type="text" class="form-control" id="id9_4" name="id9_4"><br /> 
			जिला : &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_5.jpg" alt="" id="id9_5_img" /><br />
			<input type="text" class="form-control" id="id9_5" name="id9_5"><br />
			पिन कोड &nbsp; 
			<img class="form_images" src="images/applications/38010459/id9_6.jpg" alt="" id="id9_6_img" /><br />
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			<img class="form_images" src="images/applications/38010459/id10_1.jpg" alt="" id="id10_1_img" /><br />
			<input type="text" class="form-control" id="id10_1" name="id10_1"><br />
			 (1) पिता की कुल आय (क) खेती से रु० :&nbsp;
  			<img class="form_images" src="images/applications/38010459/id10_2.jpg" alt="" id="id10_2_img" /><br />			 
			 <input type="text" class="form-control" id="id10_2" name="id10_2"><br />
			(ख) नौकरी से रु० &nbsp;
			<img class="form_images" src="images/applications/38010459/id10_3.jpg" alt="" id="id10_3_img" /><br />			
			<input type="text" class="form-control" id="id10_3" name="id10_3"><br />
			(ग) अन्य स्रोतों से रु० &nbsp;
			<img class="form_images" src="images/applications/38010459/id10_4.jpg" alt="" id="id10_4_img" /><br />			
			<input type="text" class="form-control" id="id10_4" name="id10_4"><br /><br />
			 (2) माता की कुल आय (क) खेती से रु० : &nbsp;
			<img class="form_images" src="images/applications/38010459/id10_5.jpg" alt="" id="id10_5_img" /><br />			 
			 <input type="text" class="form-control" id="id10_5" name="id10_5"><br />
			(ख) नौकरी से रु० &nbsp;
			<img class="form_images" src="images/applications/38010459/id10_6.jpg" alt="" id="id10_6_img" /><br />			
			<input type="text" class="form-control" id="id10_6" name="id10_6"><br />
			(ग) अन्य स्रोतों से रु० &nbsp;
			<img class="form_images" src="images/applications/38010459/id10_7.jpg" alt="" id="id10_7_img" /><br />			
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
			...
			<img class="form_images" src="images/applications/38010459/id11_1.jpg" alt="" id="id11_1_img" /><br />			
			<input type="text" class="form-control" id="id11_1" name="id11_1"><br />
			एवं कुल भूमि का क्षेत्रफल : &nbsp;
			<img class="form_images" src="images/applications/38010459/id11_2.jpg" alt="" id="id11_2_img" /><br />			
			<input type="text" class="form-control" id="id11_2" name="id11_2"><br />			
			पिता/अभिभावक का कुल भूमि में अंश : &nbsp;
			<img class="form_images" src="images/applications/38010459/id11_3.jpg" alt="" id="id11_3_img" /><br />			
	...
	<table class="table table-bordered">
		...
		<tbody>
		  <tr>
			<td>कक्षा-3</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_1.jpg" alt="" id="id12_1_img" /><br />
				<input type="text" class="form-control" id="id12_1" name="id12_1">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_2.jpg" alt="" id="id12_2_img" /><br />				
				<input type="text" class="form-control" id="id12_2" name="id12_2">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_3.jpg" alt="" id="id12_3_img" /><br />				
				<input type="text" class="form-control" id="id12_3" name="id12_3">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_4.jpg" alt="" id="id12_4_img" /><br />				
				<input type="text" class="form-control" id="id12_4" name="id12_4">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_5.jpg" alt="" id="id12_5_img" /><br />				
		  ...
		  <tr>
			<td>कक्षा-4</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_6.jpg" alt="" id="id12_6_img" /><br />				
				<input type="text" class="form-control" id="id12_6" name="id12_6">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_7.jpg" alt="" id="id12_7_img" /><br />				
				<input type="text" class="form-control" id="id12_7" name="id12_7">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_8.jpg" alt="" id="id12_8_img" /><br />				
				<input type="text" class="form-control" id="id12_8" name="id12_8">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_9.jpg" alt="" id="id12_9_img" /><br />				
				<input type="text" class="form-control" id="id12_9" name="id12_9">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_10.jpg" alt="" id="id12_10_img" /><br />				
		  ...
		  <tr>
			<td>कक्षा-5</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_11.jpg" alt="" id="id12_11_img" /><br />				
				<input type="text" class="form-control" id="id12_11" name="id12_11">
			</td>
			<td>
				<img class="form_images" src="images/applications/38010459/id12_12.jpg" alt="" id="id12_12_img" /><br />				
				<input type="text" class="form-control" id="id12_12" name="id12_12">
			</td>		  
			<td>
				<img class="form_images" src="images/applications/38010459/id12_13.jpg" alt="" id="id12_13_img" /><br />				
				<input type="text" class="form-control" id="id12_13" name="id12_13">
			</td>		  
			<td>
				<img class="form_images" src="images/applications/38010459/id12_14.jpg" alt="" id="id12_14_img" /><br />				
				<input type="text" class="form-control" id="id12_14" name="id12_14">
			</td>		  
			<td>
				<img class="form_images" src="images/applications/38010459/id12_15.jpg" alt="" id="id12_15_img" /><br />				
	...
	<div class="form-group">
		...
		<div class="col-xs-8">
				1. &nbsp;
				<img class="form_images" src="images/applications/38010459/id13_1.jpg" alt="" id="id13_1_img" /><br />
				<input type="text" class="form-control" id="id13_1" name="id13_1"><br />
				2. &nbsp;
				<img class="form_images" src="images/applications/38010459/id13_2.jpg" alt="" id="id13_2_img" /><br /> 
	...
	<div class="form-group">
		...
		<div class="col-xs-10">
			...
			अभिभावक का नाम &nbsp;
			<img class="form_images" src="images/applications/38010459/id14_1.jpg" alt="" id="id14_1_img" /><br /> 
			<input type="text" class="form-control" id="id14_1" name="id14_1"><br />
			आवेदक से सम्बन्ध &nbsp;
			<img class="form_images" src="images/applications/38010459/id14_2.jpg" alt="" id="id14_2_img" /><br />
			<input type="text" class="form-control" id="id14_2" name="id14_2"><br />
			अभिभावक के हस्ताक्षर &nbsp; 
			<img class="form_images" src="images/applications/38010459/id14_3.jpg" alt="" id="id14_3_img" /><br />
			----------------
		</div>
	</div>				
	...
	<div class="form-group">
		<div class="col-xs-6">
			विद्याज्ञान स्कूल में प्रवेश हेतु प्रारम्भिक लिखित परीक्षा का आवेदन एवं प्रवेश-पत्र दिनांक 	 <img class="form_images" src="images/applications/38010459/id_date.jpg" alt="" id="id_date_img" />
		</div>	
		<div class="col-xs-3">
	...
	<div class="form-group">
		<div class="col-xs-8">
			1. &nbsp;
			<img class="form_images" src="images/applications/38010459/id_998.jpg" alt="" id="id_998_img" /><br />
			<input type="text" class="form-control" id="id998" name="id998"><br />
		</div>			
		<div class="col-xs-8">
			2. &nbsp;
			<img class="form_images" src="images/applications/38010459/id_999.jpg" alt="" id="id_999_img" /><br />			
